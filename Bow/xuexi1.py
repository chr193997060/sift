...
def main(train_images_list, test_images_list, num_clusters):
    ...
    model = read_and_clusterize(train_images_list, num_clusters)

    print("Step 2: Extracting histograms of training and testing images")
    print("Training")
    [train_class, train_featvec] = calculate_centroids_histogram(train_images_list, model)
    print("Testing")
    [test_class, test_featvec] = calculate_centroids_histogram(test_images_list, model)
